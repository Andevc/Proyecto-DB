...
-- Started on 2025-06-17 11:03:37
...
--
-- TOC entry 227 (class 1255 OID 16499)
-- Name: actualizar_estado_butaca(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.actualizar_estado_butaca() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
    UPDATE butaca
...
ALTER FUNCTION public.actualizar_estado_butaca() OWNER TO postgres;

--
-- TOC entry 228 (class 1255 OID 16501)
-- Name: asignar_puntos_auto(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.asignar_puntos_auto() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
    UPDATE usuarios
...
ALTER FUNCTION public.asignar_puntos_auto() OWNER TO postgres;

--
-- TOC entry 243 (class 1255 OID 16498)
-- Name: asignar_puntos_por_entrada(integer, integer); Type: PROCEDURE; Schema: public; Owner: postgres
--

CREATE PROCEDURE public.asignar_puntos_por_entrada(IN cliente_id integer, IN cantidad integer)
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER PROCEDURE public.asignar_puntos_por_entrada(IN cliente_id integer, IN cantidad integer) OWNER TO postgres;

--
-- TOC entry 244 (class 1255 OID 16497)
-- Name: crear_reserva_completa(integer, integer, integer[]); Type: PROCEDURE; Schema: public; Owner: postgres
--

CREATE PROCEDURE public.crear_reserva_completa(IN cliente_id integer, IN sesion_id integer, IN butacas integer[])
    LANGUAGE plpgsql
    AS $$
DECLARE
    entrada_id INT;
...
ALTER PROCEDURE public.crear_reserva_completa(IN cliente_id integer, IN sesion_id integer, IN butacas integer[]) OWNER TO postgres;

--
-- TOC entry 230 (class 1255 OID 16495)
-- Name: entradas_por_clasificacion(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.entradas_por_clasificacion() RETURNS TABLE(clasificacion text, total integer)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION public.entradas_por_clasificacion() OWNER TO postgres;

--
-- TOC entry 229 (class 1255 OID 16494)
-- Name: entradas_por_genero(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.entradas_por_genero() RETURNS TABLE(genero character varying, total integer)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION public.entradas_por_genero() OWNER TO postgres;

--
-- TOC entry 231 (class 1255 OID 16496)
-- Name: ocupacion_salas(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.ocupacion_salas() RETURNS TABLE(sala text, ocupacion numeric)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION public.ocupacion_salas() OWNER TO postgres;

--
-- TOC entry 226 (class 1255 OID 16488)
-- Name: ventas_por_mes(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.ventas_por_mes() RETURNS TABLE(mes integer, total numeric)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION public.ventas_por_mes() OWNER TO postgres;
...
CREATE TABLE public.entradas (
    identrada integer DEFAULT nextval('public.entradas_identrada_seq'::regclass) NOT NULL,
    idcliente integer,
...
--
-- TOC entry 4864 (class 0 OID 16398)
-- Dependencies: 217
-- Data for Name: butaca; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.butaca (idbutaca, fila, numero, estado, idsala) FROM stdin;
1	1	1	Ocupada	1
2	1	2	Ocupada	1
3	2	3	Ocupada	2
4	2	4	Ocupada	2
...
--
-- TOC entry 4865 (class 0 OID 16403)
-- Dependencies: 218
-- Data for Name: entradas; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.entradas (identrada, idcliente, precio_total, numero_entradas) FROM stdin;
0	\N	10.00	1
1	1	15.00	2
2	2	20.00	3
3	3	10.00	1
...
COPY public.pelicula (idpelicula, titulo, sinopsis, cartel, anio, genero, clasificacion, duracion, nacionalidad) FROM stdin;
...
--
-- TOC entry 4867 (class 0 OID 16417)
-- Dependencies: 220
-- Data for Name: reserva; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.reserva (idbutaca, identrada, idsesion, coste, fecha_reserva) FROM stdin;
...
COPY public.sala (idsala, capacidad, ocupacion) FROM stdin;
1	100	50
2	150	120
3	80	40
4	200	180
...
--
-- TOC entry 4869 (class 0 OID 16424)
-- Dependencies: 222
-- Data for Name: sesion; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.sesion (idsesion, fecha, hora, idioma, idpelicula, idsala) FROM stdin;
...
COPY public.usuarios (idcliente, dni, nombre, apellidos, fecha_nac, correo, telefono, usuario, contrasena, puntos, tarjeta, fecha_registro) FROM stdin;
...
51	12345678	Andev	Andev	2003-08-21	andev@gmail.com	\N	andev	andev2i	\N	\N	2025-06-14
52	312312321	andev	andev	2025-06-13	asds@gmail.com	\N	andev	12345678	\N	\N	2025-06-15
1	12345678A	Juan	Pérez García	1985-05-20	juan.perez@gmail.com	600123456	juanp	password1	104	1234-5678-9012-3456	2022-01-01
\.
...
SELECT pg_catalog.setval('public.entradas_identrada_seq', 82, true);
...
SELECT pg_catalog.setval('public.usuarios_idcliente_seq', 52, true);


--
-- TOC entry 4695 (class 2606 OID 16442)
...
--
-- TOC entry 4709 (class 2606 OID 16450)
...
--
-- TOC entry 4711 (class 2606 OID 16452)
...
--
-- TOC entry 4702 (class 1259 OID 16455)
...
--
-- TOC entry 4699 (class 1259 OID 16454)
...
--
-- TOC entry 4703 (class 1259 OID 16456)
...
--
-- TOC entry 4707 (class 1259 OID 16458)
...
--
-- TOC entry 4696 (class 1259 OID 16453)
...
--
-- TOC entry 4718 (class 2620 OID 16500)
-- Name: reserva trg_estado_butaca; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_estado_butaca AFTER INSERT ON public.reserva FOR EACH ROW EXECUTE FUNCTION public.actualizar_estado_butaca();


--
-- TOC entry 4717 (class 2620 OID 16502)
-- Name: entradas trg_puntos_usuario; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_puntos_usuario AFTER INSERT ON public.entradas FOR EACH ROW EXECUTE FUNCTION public.asignar_puntos_auto();


--
-- TOC entry 4712 (class 2606 OID 16459)
...
--
-- TOC entry 4713 (class 2606 OID 16464)
...
--
-- TOC entry 4714 (class 2606 OID 16469)
...
--
-- TOC entry 4715 (class 2606 OID 16474)
...
-- Completed on 2025-06-17 11:03:37
