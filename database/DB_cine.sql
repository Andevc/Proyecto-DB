...
CREATE TABLE butaca (
  ...
  Fila INTEGER DEFAULT NULL ,
  Numero INTEGER DEFAULT NULL ,
  Estado VARCHAR(20) CHECK (Estado IN ('Libre','Ocupada')) DEFAULT NULL ,
  idSala INTEGER DEFAULT NULL 
);
...
CREATE TABLE entradas (
  ...
  Precio_Total NUMERIC(10,2) DEFAULT NULL ,
  Numero_Entradas INTEGER DEFAULT NULL 
)  ;
...
CREATE TABLE reserva (
  idButaca INTEGER DEFAULT NULL ,
  idEntrada INTEGER DEFAULT NULL ,
  idSesion INTEGER DEFAULT NULL ,
  Coste NUMERIC(10,2) DEFAULT NULL ,
...
CREATE TABLE sesion (
  ...
  idPelicula INTEGER DEFAULT NULL ,
  idSala INTEGER DEFAULT NULL 
)  ;
...
-- Índices (en lugar de ADD KEY de MySQL)
CREATE INDEX idx_idSala ON butaca(idSala);
CREATE INDEX idx_idCliente ON entradas(idCliente);
CREATE INDEX idx_idButaca ON reserva(idButaca);
CREATE INDEX idx_idEntrada ON reserva(idEntrada);
CREATE INDEX idx_idSesion ON reserva(idSesion);
CREATE INDEX idx_idPelicula ON sesion(idPelicula);
